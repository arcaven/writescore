...
class TestParameterChange:
    ...
    def test_get_change_summary_nested_changes(self):
        ...
        old_params = DimensionParameters(
            ...
            parameters=ThresholdParameters(boundaries={
                'excellent_good': 0.75,
...
class TestRecalibrationWorkflow:
    ...
    def test_run_distribution_analysis(self):
        ...
        # Create dataset
        workflow.dataset = ValidationDataset(
            version="v1.0",
            created="2025-11-24T10:00:00Z"
        )
        workflow.dataset.add_document(Document(
            id="h1",
            text="Human text",
            label="human",
            word_count=2
