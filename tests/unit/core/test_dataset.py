...
class TestValidationDataset:
    ...
    def test_add_document(self):
        ...
        doc = Document(id="doc_001", text="Test content", label="human", word_count=2)
    ...
    def test_get_documents_by_label(self):
        ...
        dataset.add_document(Document(id="human_1", text="Test", label="human", word_count=1))
        dataset.add_document(
            Document(id="ai_1", text="Test", label="ai", ai_model="gpt-4", word_count=1)
        )
        dataset.add_document(Document(id="human_2", text="Test", label="human", word_count=1))
    ...
    def test_get_documents_by_domain(self):
        ...
        dataset.add_document(
            Document(id="doc_1", text="Test", label="human", domain="academic", word_count=1)
        )
        dataset.add_document(
            Document(id="doc_2", text="Test", label="human", domain="social", word_count=1)
        )
        dataset.add_document(
            Document(id="doc_3", text="Test", label="human", domain="academic", word_count=1)
        )
    ...
    def test_get_documents_by_model(self):
        ...
        dataset.add_document(
            Document(id="doc_1", text="Test", label="ai", ai_model="gpt-4", word_count=1)
        )
        dataset.add_document(
            Document(id="doc_2", text="Test", label="ai", ai_model="claude-3", word_count=1)
        )
        dataset.add_document(
            Document(id="doc_3", text="Test", label="ai", ai_model="gpt-4", word_count=1)
        )
    ...
    def test_validate_duplicate_ids_rejected(self):
        ...
        dataset.add_document(Document(id="duplicate", text="Test", label="human", word_count=1))
        dataset.add_document(Document(id="duplicate", text="Test", label="human", word_count=1))
...
class TestDatasetLoader:
    ...
    def test_save_and_load_jsonl_file(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            # Create dataset
            original = ValidationDataset(version="v1.0", created="2025-11-24T10:00:00Z")
    ...
    def test_compute_dataset_hash(self):
        ...
        dataset.add_document(Document(id="doc_1", text="Test content", label="human", word_count=2))
        dataset.add_document(Document(id="doc_2", text="More content", label="human", word_count=2))
        ...
        dataset.add_document(Document(id="doc_3", text="New content", label="human", word_count=2))
    ...
    def test_roundtrip_preserves_data(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            original = ValidationDataset(
                version="v1.0", created="2025-11-24T10:00:00Z", metadata={"test": "value"}
            )
