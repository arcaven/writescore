...
Full paths:
- Dimension files: `.bmad-technical-writing/data/tools/writescore/dimensions/`
- Test files: `.bmad-technical-writing/data/tools/writescore/tests/`
...
```python
from writescore.dimensions.advanced import AdvancedDimension
from writescore.dimensions.stylometric import StylometricDimension
...
**Test File Location:**
- Unit tests: `.bmad-technical-writing/data/tools/writescore/tests/unit/dimensions/`
- Integration tests: `.bmad-technical-writing/data/tools/writescore/tests/integration/`
...
- PredictabilityDimension: 20% ADVANCED (.bmad-technical-writing/data/tools/writescore/dimensions/predictability.py:75,80)
- AdvancedLexicalDimension: 14% ADVANCED (.bmad-technical-writing/data/tools/writescore/dimensions/advanced_lexical.py:71,76)
- ReadabilityDimension: 10% CORE (.bmad-technical-writing/data/tools/writescore/dimensions/readability.py:68,73)
- TransitionMarkerDimension: 10% ADVANCED (.bmad-technical-writing/data/tools/writescore/dimensions/transition_marker.py:61,66)
